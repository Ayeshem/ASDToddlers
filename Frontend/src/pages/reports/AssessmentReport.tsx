...
export default function AssessmentReport() {
  ...
  const displayData = hasBackendData ? {
    ...
    riskLevel: latestAssessment!.riskLevel.toLowerCase(), // normalize to lowercase
    fixationCount: latestAssessment!.fixationCount,
    gazeDeviation: latestAssessment!.gazeDeviation,
    source: 'mock'
  };

  // normalize risk for UI usage
  const risk = (displayData.riskLevel || "").toLowerCase();
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground mt-1">
                    <span className="font-semibold">{resolvedChild.name}</span> • {calculateAge(resolvedChild.dob)} • 
                    <span className="ml-1">
                  ...
                  <div className="flex items-center gap-2 mt-2">
                    ...
                    {error && (
                      <div className="flex items-center gap-1 text-xs text-risk-moderate">
              ...
              <div className="space-y-6">
                ...
                <div className="p-4 bg-gray-50 rounded-lg">
                  ...
                  <div className="space-y-2 text-gray-700">
                    ...
                    <p><strong>Risk Assessment:</strong> {risk === 'safe' ? 'Safe' : `${risk} risk level`}</p>
                    ...
                    {risk === 'safe' && (
                      <div className="mt-3 p-3 bg-emerald-50 border border-emerald-200 rounded">
                        <p className="text-emerald-800 font-medium">✅ Safe</p>
                        <p className="text-emerald-700 text-sm">No immediate concerns detected. Continue routine developmental monitoring and healthy practices.</p>
                      </div>
                    )}
                  </div>
                </div>
