...
import { Edit, Trash2, Play, FileText, MoreVertical, History } from "lucide-react"; // ✅ added History icon
import type { Child } from "@/services/childrenApi";
import { format } from "date-fns";
...
interface ChildCardProps {
  ...
  onStartSession: (child: Child) => void;
  onViewReports: (child: Child) => void;
  onViewHistory: (child: Child) => void; // ✅ FIXED
}
        ...
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              ...
              profile for{" "}
              <span className="font-semibold">{child.name}</span> and all
              associated data.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
